...
class MovieController extends Controller
{
    ...
    public function show(Movie $movie): JsonResponse
    {
        $movie->load(['genre:id,genre_name', 'reviews' => function ($query) {
            $query->select('reviews.id', 'reviews.movie_id', 'reviews.content', 'reviews.rating', 'reviews.review_date', 'users.name as user_name', 'users.profile_image as user_profile_image')
